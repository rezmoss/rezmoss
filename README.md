[![Twitter](https://img.shields.io/badge/𝕏-@rez__moss-black?style=flat-square)](https://twitter.com/rez_moss)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-rezmoss-0A66C2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/rezmoss/)
[![Website](https://img.shields.io/badge/Blog-rezmoss.com-blue?style=flat-square)](https://rezmoss.com)
[![AWS](https://img.shields.io/badge/AWS-Community-FF9900?style=flat-square)](https://builder.aws.com/community/@rezmoss)

I'm a developer and system builder. Currently leading VM scanning at [@AikidoSec](https://github.com/AikidoSec). Founder of [CloudAid](https://github.com/cloudaidnet). I work primarily in **Go**, **Node.js**, and **AWS**.
...
|---------|-------------|
| [cloud-provider-ip-addresses](https://github.com/rezmoss/cloud-provider-ip-addresses) | Daily-updated IP ranges for 60+ providers (AWS, Azure, GCP, Cloudflare, GitHub, Fastly,Linode + GoogleBot/BingBot/GPTBot) in 12+ formats |
